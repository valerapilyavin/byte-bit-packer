...
function toBigInt(value) {
    const _hi = BigInt(value.hi);
    const _lo = BigInt(value.lo);
    return (_hi << 32n) | _lo;
}
...
export async function tst4() {
    it('ReadWriteU64', async (ctx) => {
        await ctx.test("writeU64", () => {
            ...
            packer.writeU64(0, fromBigInt(0x1122334455667788n));
            ...
            packer.writeU64(0, fromBigInt(0x1122334455667788n), false);
            ...
            packer.writeU64(0, fromBigInt(0x1122334455667788n), true);
            if (packer.readU8(0) != 0x88) {
                throw new Error("packer.readU8(0) != 0x88");
            }
            if (packer.readU8(1) != 0x77) {
            ...
            assert.throws(() => {
                packer.writeU64(1, fromBigInt(0x1122334455667788n));
        ...
        await ctx.test("readU64", () => {
            let packer = new BBPacker(8, { littleEndian: true });
            packer.writeU64(0, fromBigInt(0x1122334455667788n));
            if (toBigInt(packer.readU64(0)) != 0x1122334455667788n) {
                throw new Error("toBigInt(packer.readU64(0))  != 0x11_22_33_44_55_66_77_88n");
            }
            if (toBigInt(packer.readU64(0, false)) != 0x8877665544332211n) {
        ...
        await ctx.test("writeArrU64,readArrU64", () => {
            ...
            packer.writeArrU64(0, [fromBigInt(0x1122334455667788n), fromBigInt(0x0102030405060708n)]);
            assert.throws(() => {
                packer.writeArrU64(2, [fromBigInt(0x0000334455667788n), fromBigInt(0x0102030405060708n)]);
            }, () => true, "packer.writeArrU64( 2 ,  [ fromBigInt( 0x00_00_33_44_55_66_77_88n )  , fromBigInt( 0x01_02_03_04_05_06_07_08n ) ] );");
            assert.throws(() => {
                packer.writeArrU64(0, [fromBigInt(0x11aa334455667788n), fromBigInt(0x01bb030405060708n), fromBigInt(0x01cc030405060708n)]);
            ...
            if (toBigInt(arr1[0]) != 0x1122334455667788n) {
                throw new Error("toBigInt(arr1[0])   != 0x11_22_33_44_55_66_77_88n");
            }
            if (toBigInt(arr1[1]) != 0x0102030405060708n) {
            ...
            if (toBigInt(arr2[0]) != 0x1122334455667788n) {
            ...
            if (toBigInt(arr3[0]) != 0x8877665544332211n) {
                throw new Error("toBigInt(arr3[0]) !=  0x88_77_66_55_44_33_22_11n");
            }
            if (toBigInt(arr3[1]) != 0x0807060504030201n) {
            ...
            if (toBigInt(arr4[0]) != 0x8877665544332211n) {
                throw new Error("toBigInt(arr4[0]) != 0x88_77_66_55_44_33_22_11n");
            }
            packer.writeArrU64(0, [fromBigInt(0x1122334455667788n), fromBigInt(0x0102030405060708n)], false);
            const arr5 = packer.readArrU64(0, 1);
            if (arr5.length != 1) {
                throw new Error("arr5.length != 1");
            }
            if (toBigInt(arr5[0]) != 0x8877665544332211n) {
        ...
        await ctx.test("putU64,getU64", () => {
            ...
            packer.putU64(fromBigInt(0x1122334455667788n));
            packer.putU64(fromBigInt(0x0102030405060708n));
            packer.resetIndex();
            if (toBigInt(packer.getU64()) != 0x1122334455667788n) {
                throw new Error(" toBigInt(packer.getU64()) != 0x11_22_33_44_55_66_77_88n");
            }
            if (toBigInt(packer.getU64()) != 0x0102030405060708n) {
                throw new Error("toBigInt(packer.getU64()) != 0x01_02_03_04_05_06_07_08n");
            }
            packer.resetIndex();
            packer.putU64(fromBigInt(0x1122334455667788n), false);
            packer.putU64(fromBigInt(0x0102030405060708n), false);
            packer.resetIndex();
            if (toBigInt(packer.getU64()) != 0x8877665544332211n) {
                throw new Error("toBigInt(packer.getU64()) != 0x88_77_66_55_44_33_22_11n");
            }
            if (toBigInt(packer.getU64()) != 0x0807060504030201n) {
            ...
            packer.putU64(fromBigInt(0x0102030405060708n));
            packer.resetIndex();
            if (toBigInt(packer.getU64(false)) != 0x8877665544332211n) {
                throw new Error("toBigInt(packer.getU64(false)) != 0x88_77_66_55_44_33_22_11n");
            }
            if (toBigInt(packer.getU64(false)) != 0x0807060504030201n) {
        ...
        await ctx.test("putArrU64,getArrU64", () => {
            let packer = new BBPacker(17, { littleEndian: true });
            packer.putArrU64([fromBigInt(0x1122334455667788n), fromBigInt(0x0102030405060708n)]);
            assert.throws(() => {
                packer.putArrU64([fromBigInt(0x0000000000000000n)]);
            ...
            packer.resetIndex();
            packer.putArrU64([fromBigInt(0x1122334455667788n), fromBigInt(0x0102030405060708n)], false);
            packer.resetIndex();
    ...
    it('ReadWriteI64', async (ctx) => {
        await ctx.test("writeI64", () => {
            let packer = new BBPacker(8, { littleEndian: true });
            packer.writeI64(0, fromBigInt(0x1122334455667788n));
            if (packer.readU8(0) != 0x88) {
                throw new Error("packer.readU8(0) != 0x88");
            }
            if (packer.readU8(1) != 0x77) {
            ...
            packer.writeI64(0, fromBigInt(0x1122334455667788n), false);
            if (packer.readU8(0) != 0x11) {
                throw new Error("packer.readU8(0) != 0x11");
            }
            if (packer.readU8(1) != 0x22) {
            ...
            packer.writeI64(0, fromBigInt(0x1122334455667788n), true);
            if (packer.readU8(0) != 0x88) {
                throw new Error("packer.readU8(0) != 0x88");
            }
            if (packer.readU8(1) != 0x77) {
            ...
            assert.throws(() => {
                packer.writeI64(1, fromBigInt(0x1122334455667788n));
            }, () => true, "packer.writeI64( 1 , fromBigInt( 0x11_22_33_44_55_66_77_88n ) );");
            return assert.ok(true);
        });
        await ctx.test("readI64", () => {
            let packer = new BBPacker(8, { littleEndian: true });
            packer.writeI64(0, fromBigInt(0x1122334455667708n));
            if (toBigInt(packer.readI64(0)) != 0x1122334455667708n) {
                throw new Error("toBigInt(packer.readI64(0))  != 0x11_22_33_44_55_66_77_08n");
            }
            if (toBigInt(packer.readI64(0, false)) != 0x0877665544332211n) {
                throw new Error("toBigInt(packer.readU64(0,false))  != 0x08_77_66_55_44_33_22_11n");
            }
            assert.throws(() => {
                packer.readI64(1);
            }, () => true, "packer.readI64( 1 );");
            packer.writeI64(0, fromBigInt(-0xffffffffffffn));
            if (toBigInt(packer.readI64(0)) != -0xffffffffffffn) {
        ...
        await ctx.test("writeArrI64,readArrI64", () => {
            let packer = new BBPacker(17, { littleEndian: true });
            packer.writeArrI64(0, [fromBigInt(0x1122334455667708n), fromBigInt(0x0102030405060708n)]);
            assert.throws(() => {
                packer.writeArrI64(2, [fromBigInt(0x0000334455667708n), fromBigInt(0x0102030405060708n)]);
            }, () => true, "packer.writeArrI64( 2 ,  [ fromBigInt( 0x00_00_33_44_55_66_77_08n )  , fromBigInt( 0x01_02_03_04_05_06_07_08n ) ] );");
            assert.throws(() => {
                packer.writeArrI64(0, [fromBigInt(0x11aa334455667708n), fromBigInt(0x01bb030405060708n), fromBigInt(0x01cc030405060708n)]);
            ...
            if (toBigInt(arr1[0]) != 0x1122334455667708n) {
            ...
            if (toBigInt(arr2[0]) != 0x1122334455667708n) {
            ...
            if (toBigInt(arr3[0]) != 0x0877665544332211n) {
            ...
            if (toBigInt(arr4[0]) != 0x0877665544332211n) {
                throw new Error("toBigInt(arr4[0]) != 0x08_77_66_55_44_33_22_11n");
            }
            packer.writeArrI64(0, [fromBigInt(0x1122334455667708n), fromBigInt(0x0102030405060708n)], false);
            const arr5 = packer.readArrI64(0, 1);
            if (arr5.length != 1) {
                throw new Error("arr5.length != 1");
            }
            if (toBigInt(arr5[0]) != 0x0877665544332211n) {
                throw new Error("toBigInt(arr5[0]) != 0x08_77_66_55_44_33_22_11n");
            }
            packer.writeArrI64(0, [fromBigInt(-0xffffffffffffn), fromBigInt(-0x0fffffffffffn)]);
            const arr6 = packer.readArrI64(0);
            if (arr6.length != 2) {
                throw new Error("arr6.length != 2");
            }
            if (toBigInt(arr6[0]) != -0xffffffffffffn) {
                throw new Error("toBigInt(arr6[0])   != -0xFFFF_FFFF_FFFFn");
            }
            if (toBigInt(arr6[1]) != -0x0fffffffffffn) {
        ...
        await ctx.test("putI64,getI64", () => {
            let packer = new BBPacker(16, { littleEndian: true });
            packer.putI64(fromBigInt(0x1122334455667708n));
            packer.putI64(fromBigInt(0x0102030405060708n));
            packer.resetIndex();
            if (toBigInt(packer.getI64()) != 0x1122334455667708n) {
                throw new Error(" toBigInt(packer.getI64()) != 0x11_22_33_44_55_66_77_08n");
            }
            if (toBigInt(packer.getI64()) != 0x0102030405060708n) {
                throw new Error("toBigInt(packer.getI64()) != 0x01_02_03_04_05_06_07_08n");
            }
            packer.resetIndex();
            packer.putI64(fromBigInt(0x1122334455667708n), false);
            packer.putI64(fromBigInt(0x0102030405060708n), false);
            packer.resetIndex();
            if (toBigInt(packer.getI64()) != 0x0877665544332211n) {
                throw new Error("toBigInt(packer.getI64()) != 0x08_77_66_55_44_33_22_11n");
            }
            if (toBigInt(packer.getI64()) != 0x0807060504030201n) {
            ...
            packer.putI64(fromBigInt(0x0102030405060708n));
            packer.resetIndex();
            if (toBigInt(packer.getI64(false)) != 0x0877665544332211n) {
                throw new Error("toBigInt(packer.getI64(false)) != 0x08_77_66_55_44_33_22_11n");
            }
            if (toBigInt(packer.getI64(false)) != 0x0807060504030201n) {
                throw new Error("toBigInt(packer.getI64(false)) != 0x08_07_06_05_04_03_02_01n");
            }
            assert.throws(() => {
                packer.putI64(fromBigInt(0x1122334455667788n));
            }, () => true, "packer.putI64( fromBigInt( 0x11_22_33_44_55_66_77_88n )  );");
            assert.throws(() => {
                packer.getI64();
            }, () => true, "packer.getI64(  );");
            packer.resetIndex();
            packer.putI64(fromBigInt(-0xffffffff0000n));
            packer.putI64(fromBigInt(-0x5555ffff0000n));
            packer.resetIndex();
            if (toBigInt(packer.getI64()) != -0xffffffff0000n) {
                throw new Error(" toBigInt(packer.getI64()) != -0xFFFF_FFFF_0000n");
            }
            if (toBigInt(packer.getI64()) != -0x5555ffff0000n) {
        ...
        await ctx.test("putArrI64,getArrI64", () => {
            let packer = new BBPacker(17, { littleEndian: true });
            packer.putArrI64([fromBigInt(0x1122334455667708n), fromBigInt(0x0102030405060708n)]);
            assert.throws(() => {
                packer.putArrI64([fromBigInt(0x0000000000000000n)]);
            ...
            packer.resetIndex();
            packer.putArrI64([fromBigInt(0x1122334455667708n), fromBigInt(0x0102030405060708n)], false);
            packer.resetIndex();
            ...
            packer.resetIndex();
            packer.putArrI64([fromBigInt(-0xffffffff5555n), fromBigInt(-0xffffffffaaaan)]);
            packer.resetIndex();
            const arr6 = packer.getArrI64();
            if (arr6.length != 2) {
                throw new Error("arr6.length != 2");
            }
            if (toBigInt(arr6[0]) != -0xffffffff5555n) {
                throw new Error("toBigInt(arr6[0]) != -0xFFFF_FFFF_5555n");
            }
            if (toBigInt(arr6[1]) != -0xffffffffaaaan) {
